...
all_ruby_prepare() {
	...
	# patch for virtualbox-5.1
	# see https://github.com/mitchellh/vagrant/issues/7411#issuecomment-232305067
	epatch "${FILESDIR}"/${PN}-1.8.4-r1.patch
	cp "${FILESDIR}"/version_5_1.rb "${S}"/plugins/providers/virtualbox/driver/version_5_1.rb
}
